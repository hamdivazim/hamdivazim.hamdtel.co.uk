    ...
    <section id="about">
      <div className="container mx-auto flex px-10 py-20 md:flex-row flex-col-reverse items-center">
        <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
          ...
          <h3 className="title-font sm:text-lg text-md mb-4 font-medium text-white">
            App Builder, Game Maker and Learner
          </h3>

          <p className="mb-8 leading-relaxed">
            I've been building apps and games since I was six - now I can analyse datasets, make applications for iOS, Android & the web, build games with Unity, deploy infrastructure with AWS and much more. 
