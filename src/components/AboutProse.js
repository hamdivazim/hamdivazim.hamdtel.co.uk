...
export default function AboutProse() {
    return (
        <div className="prose prose-lg prose-invert max-w-none px-6 pb-6">
            ...
            <p className="leading-relaxed mb-4">I’ve worked on a range of projects, from a simple e-commerce app for iOS to a Google data analysis notebook in Python, and even a fully scalable architecture with AWS! A full list of both my released projects and upcoming projects is at <Link href="/projects" className="text-cyan-400 hover:text-cyan-300 hover:underline">/projects</Link>, so feel free to check them out, or check out my GitHub at <a href="https://github.com/hamdivazim" className="text-cyan-400 hover:text-cyan-300 hover:underline">hamdivazim</a>!</p>
            ...
            <p className="leading-relaxed mb-4">Thank you so much for exploring my portfolio! Feel free to check out my <Link href="/blog" className="text-cyan-400 hover:text-cyan-300 hover:underline">blog</Link>, my <Link href="/projects" className="text-cyan-400 hover:text-cyan-300 hover:underline">latest projects</Link>, my <Link href="/devlog" className="text-cyan-400 hover:text-cyan-300 hover:underline">devlog</Link> or if you&apos;d like to get in touch, email me via the links above. I&apos;d love to hear from you!</p>
        </div>
    )
}